...
public class TestFVCreator {
	...
	public static void main(String[] args) throws Exception {
		...
		File cleanTest = new File(Constants.FILES_SOURCE_DIRECTORY + "cleanTestMFVWithoutLocation.csv");
		FileWriter fw = new FileWriter(cleanTest);
		
		ArrayList<MainFeatureVectorModel> fvectors = new ArrayList<MainFeatureVectorModel>();
		iterator.next();
		...
		while(iterator.hasNext()){
			...
			// find user record
			Reader usersReader = new FileReader(Constants.CLEAN_USERS_DATA);
			...
			// find event record
			Reader eventsReader = new FileReader(Constants.CLEAN_EVENTS_DATA);
			...
			Reader friendsReader = new FileReader(Constants.CLEAN_FRIENDS_DATA);
			...
			Reader attendeesReader = new FileReader(Constants.CLEAN_ATTENDEES_DATA);
